...
logger.add(log_file_path, rotation="5 MB", retention='10 days', encoding="utf-8")
logger.add(err_log_file_path, rotation="5 MB", retention='10 days', encoding="utf-8", level="ERROR")

# Quick-start development settings - unsuitable for production
# See https://docs.djangoproject.com/en/3.2/howto/deployment/checklist/

# SECURITY WARNING: keep the secret key used in production secret!
SECRET_KEY = 'django-insecure-2$6y4-*-l$fo$6hxibw)d%dkx_k6o2km$3c5(booo00##+ostz'
